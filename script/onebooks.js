let allBooks = [ {
    ...
    link: "../pages/part_4.html",
    url: "https://www.knihydobrovsky.cz/kniha/zaklinac-iv-cas-opovrzeni-11972",
},{
    id: 4,
    ...
    link: "../pages/part_5.html",
    url: "https://www.knihydobrovsky.cz/kniha/zaklinac-v-krest-ohnem-38398",
    ...
    language: "český", 
    popis:"Had Uroboros se zakousl do vlastního ocasu. Něco končí, něco začíná. Také příběh Zaklínačova hledání dospěl k závěru, Ciri, Geralt i Yennefer se na pozadí krvavého válečného konfliktu konečně setkají, ovšem podobně jako v předchozích dílech ságy nelze očekávat, že věci půjdou tak snadno, jak byly naplánovány. Příběh Dítěte Překvapení, zlověstné věštby, lásky, krutosti a událostí, měnících tvář světa, se uzavírá v mohutném finále, v gejzíru imaginace, aby jednou provždy změnil fantastickou literaturu. Had Uroboros drží v zubech vlastní ocas, něco skončilo a cosi začíná.",
    link: "../pages/part_7.html",
    url: "https://www.knihydobrovsky.cz/kniha/zaklinac-vii-pani-jezera-90612",

},]


// Funkce pro výpis knih na každou stránku
let oneBook = () => {
    // číslo knih

    let number = ""

    // podle page zadej číslo 
    if(document.querySelector(".part_01")){
        number = allBooks[0].id
    } else if(document.querySelector(".part_02")){
        number =  allBooks[1].id
    } else if(document.querySelector(".part_03")){
        number =  allBooks[2].id
    } else if(document.querySelector(".part_04")){
        number =  allBooks[3].id
    } else if(document.querySelector(".part_05")){
        number = allBooks[4].id
    } else if(document.querySelector(".part_06")){
        number =  allBooks[5].id
    } else if(document.querySelector(".part_07")){
        number =  allBooks[6].id
    }
    ...
    <div class="containerPart">
               ...
               <div class="description">
                   <p>${allBooks[number].popis}</p>
               </div>
           </div>
   `
    document.querySelector(".part").appendChild(part)
...
//                 <div class="details">
//                     <h3>${allBooks[0].name}</h3>
//                     <p>Publikováno:${allBooks[0].publication}</p>
//                     <p>Autor:${allBooks[0].author}</p>
//                     <p>Počet Stran:${allBooks[0].pages}</p>
//                     <p>ISBN:${allBooks[0].ISBN}</p>
//                     <p>Jazyk:${allBooks[0].language}</p>
//                     <a href="${allBooks[0].url}" target="_blank" rel="noopener noreferrer">Odkaz do obchodu</a>
//                 </div>
//             </div>
//             <div class="description">
//                 <p>${allBooks[0].popis}</p>
//             </div>
//         </div>
// `
//  document.querySelector(".part_01").appendChild(part1)
// }


//  // Part_2
// if(document.querySelector(".part_02")){
//     let part2 = document.createElement("div")
//     part2.innerHTML = `
    
//     <div class="containerPart">
//                <div class="box">
//                    <img src="${allBooks[1].image}">
//                    <div class="details">
//                        <h3>${allBooks[1].name}</h3>
//                        <p>Publikováno:${allBooks[1].publication}</p>
//                        <p>Autor:${allBooks[1].author}</p>
//                        <p>Počet Stran:${allBooks[1].pages}</p>
//                        <p>ISBN:${allBooks[1].ISBN}</p>
//                        <p>Jazyk:${allBooks[1].language}</p>
//                        <a href="${allBooks[1].url}" target="_blank" rel="noopener noreferrer">Odkaz do obchodu</a>
//                    </div>
//                </div>
//                <div class="description">
//                    <p>${allBooks[1].popis}</p>
//                </div>
//            </div>
//     `
//     document.querySelector(".part_02").appendChild(part2)
// }
...
// // Part3
// if(document.querySelector(".part_03")){
// let part3 = document.createElement("div")
//  part3.innerHTML = `
 
//  <div class="containerPart">
//             <div class="box">
//                 <img src="${allBooks[2].image}">
//                 <div class="details">
//                     <h3>${allBooks[2].name}</h3>
//                     <p>Publikováno:${allBooks[2].publication}</p>
//                     <p>Autor:${allBooks[2].author}</p>
//                     <p>Počet Stran:${allBooks[2].pages}</p>
//                     <p>ISBN:${allBooks[2].ISBN}</p>
//                     <p>Jazyk:${allBooks[2].language}</p>
//                     <a href="${allBooks[2].url}" target="_blank" rel="noopener noreferrer">Odkaz do obchodu</a>
//                 </div>
//             </div>
//             <div class="description">
//                 <p>${allBooks[2].popis}</p>
//             </div>
//         </div>
// `
//  document.querySelector(".part_03").appendChild(part3)
// }
...
//        </div>
// `
// document.querySelector(".part_04").appendChild(part4)
// }
...
//             </div>
//     `
//      document.querySelector(".part_05").appendChild(part5)
// }
...
//            </div>
//     `
//     document.querySelector(".part_06").appendChild(part6)
...
//             </div>
//     `
//      document.querySelector(".part_07").appendChild(part7)
